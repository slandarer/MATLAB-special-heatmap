%% Colorbar rotation (GroupLabel 1)
...
SHM.frameHdl.YData(SHM.frameHdl.YData < SHM.frameHdl.XData) = ...
SHM.frameHdl.XData(SHM.frameHdl.YData < SHM.frameHdl.XData);
for i = 1:size(Data, 2)
    SHM.patchHdl(i, i).YData(2) = SHM.patchHdl(i, i).XData(2);
end
for i = 1:length(SHM.rowGroupLabelHdl)
